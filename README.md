...
me raskri: react shaka player - run shaka-player using react.
google shaka: https://shaka-player-demo.appspot.com/docs/api/tutorial-basic-usage.html
facebook react: https://facebook.github.io/react/

:)

Output from running:
$: create-react-app react-shaka-player
